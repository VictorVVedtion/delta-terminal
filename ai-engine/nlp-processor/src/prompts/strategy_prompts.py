...
- 用户说"好的"、"可以"、"做吧"、"那就这样"、"那制定这个策略吧"、"都可以"、"都行"、"没问题"、"行"、"ok"、"OK"、"好"、"嗯"、"对"、"是的"、"没错"、"就这样"、"确认"、"同意" → 如果之前是 analyze_market，则现在是 create_strategy
- 用户说"开始回测"、"测试一下" → backtest
- 用户说"启动"、"运行" → 这是策略执行确认
- **重要**：任何表示肯定/同意的简短回复都应视为确认，设置 is_confirmation=true
