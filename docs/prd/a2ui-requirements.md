...
**优先级**: P0
**描述**: AI 引擎在响应用户策略相关请求时，必须返回结构化的 InsightData 而非纯文本。
...
**优先级**: P0
**描述**: InsightData 在 Chat 面板中以紧凑卡片形式展示。
